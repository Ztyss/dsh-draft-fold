...
.dsh-draft-fold-card__title {
  margin: 0;
  font-size: 14px;
  font-weight: 600;
}

.dsh-draft-fold-card__desc {
  margin: 0;
  font-size: 12px;
  color: var(--dsw-alias-label-tertiary);
}

.dsh-draft-fold-card__field {
  display: flex;
  flex-direction: column;
  gap: 4px;
}

.dsh-draft-fold-card__label {
  display: flex;
  gap: 8px;
  align-items: center;
  font-size: 13px;
...
.dsh-draft-fold-card__row {
  display: flex;
  gap: 6px;
  align-items: center;
}

.dsh-draft-fold-card__input {
  width: 180px;
  padding: 6px 10px;
  border: 1px solid var(--dsw-alias-border-l2);
  border-radius: 8px;
...
.dsh-draft-fold-card__input:focus-visible {
  outline: 2px solid var(--dsw-alias-state-business-primary);
  outline-offset: 1px;
}

.dsh-draft-fold-card__input[data-invalid] {
  border-color: var(--dsw-alias-state-error, #d5494c);
}

.dsh-draft-fold-card__input:disabled {
  opacity: 0.5;
}

.dsh-draft-fold-card__hint {
  font-size: 12px;
  color: var(--dsw-alias-label-tertiary);
}

.dsh-draft-fold-card__reset {
  border: 0;
  padding: 2px 6px;
  border-radius: 6px;
  background: transparent;
...
.dsh-draft-fold-card__reset:hover:not(:disabled) {
  background: var(--dsw-alias-interactive-bg-hover);
  color: var(--dsw-alias-label-primary);
}

.dsh-draft-fold-card__footer {
  display: flex;
  gap: 8px;
  align-items: center;
...
.dsh-draft-fold-card__badge {
  margin-right: auto;
  font-size: 11px;
  color: var(--dsw-alias-label-tertiary);
}

.dsh-draft-fold-card__button {
  padding: 6px 14px;
  border: 1px solid var(--dsw-alias-border-l2);
  border-radius: 8px;
  background: transparent;
...
.dsh-draft-fold-card__button:hover:not(:disabled) {
  background: var(--dsw-alias-interactive-bg-hover);
}

.dsh-draft-fold-card__button:focus-visible {
  outline: 2px solid var(--dsw-alias-state-business-primary);
  outline-offset: 1px;
}

.dsh-draft-fold-card__button:disabled {
  opacity: 0.5;
  cursor: default;
}

.dsh-draft-fold-card__button--save {
...
`;
		...
		/** Render the 草稿折叠 settings card from one staged-form snapshot. */
		function DraftFoldCard(props) {
			const state = props.useDraftFoldCard((snapshot) => snapshot);
			const t = props.t;
			const disabled = !state.writable;
			const fieldRow = (name, labelKey, hintKey) => {
				const field = state[name];
				return (0, react_jsx_runtime.jsxs)("div", { className: "dsh-draft-fold-card__field", children: [
					(0, react_jsx_runtime.jsxs)("div", { className: "dsh-draft-fold-card__label", children: [
						(0, react_jsx_runtime.jsx)("span", { children: t(labelKey) }),
						field.overridden || field.staged ? (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dsh-draft-fold-card__reset",
							disabled,
					...
					(0, react_jsx_runtime.jsx)("input", {
						type: "text",
						inputMode: "numeric",
						className: "dsh-draft-fold-card__input",
						value: field.text,
						disabled,
						"aria-label": t(labelKey),
						"data-invalid": field.valid ? void 0 : "true",
						onChange: (event) => props.edit(name, event.target.value)
					}),
					(0, react_jsx_runtime.jsx)("div", { className: "dsh-draft-fold-card__hint", children: field.valid ? t(hintKey) : t("settings.invalidNumber") })
				] }, name);
			};
			return (0, react_jsx_runtime.jsxs)("section", {
				className: "dsh-draft-fold-card",
				"data-testid": "draft-fold-card",
				children: [
					(0, react_jsx_runtime.jsx)("h3", { className: "dsh-draft-fold-card__title", children: t("settings.title") }),
					(0, react_jsx_runtime.jsx)("p", { className: "dsh-draft-fold-card__desc", children: t("settings.description") }),
					!state.writable ? (0, react_jsx_runtime.jsx)("p", { className: "dsh-draft-fold-card__desc", children: t("settings.readOnly") }) : null,
					fieldRow("threshold", "settings.threshold", "settings.thresholdHint"),
					fieldRow("previewChars", "settings.previewChars", "settings.previewHint"),
					state.failed ? (0, react_jsx_runtime.jsx)("p", { className: "dsh-draft-fold-card__hint", children: t("settings.saveFailed") }) : null,
					(0, react_jsx_runtime.jsxs)("div", { className: "dsh-draft-fold-card__footer", children: [
						state.dirty ? (0, react_jsx_runtime.jsx)("span", { className: "dsh-draft-fold-card__badge", children: t("settings.unsaved") }) : null,
						(0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dsh-draft-fold-card__button",
						...
						(0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dsh-draft-fold-card__button dsh-draft-fold-card__button--save",
							disabled: disabled || !state.dirty || state.saving,
							onClick: () => props.save(),
		...
		function apply(ctx) {
			...
			const card = new DraftFoldCardController(scope);
